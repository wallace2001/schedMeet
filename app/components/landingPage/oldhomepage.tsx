      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              Agendamento realizado <span className="text-blue-600">super fácil!</span>
          </h1>
          <p className="mt-3 text-lg text-gray-800 dark:text-neutral-400">
          Conheça o SchedMeet, o planejador de agendamento para todos. Foco
            em suas reuniões, não em agendá-las. Gratuito para pessoas físicas.
          </p>
          {/* Buttons */}
          ...
          <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            ...
            <div className="py-5">
              ...
              <p className="mt-3 text-sm text-gray-800 dark:text-neutral-200">
                <span className="font-bold">4.6</span> /5 - de 12 mil avaliações
              </p>
              <div className="mt-5">
                {/* Star */}
                <svg
            ...
            <div className="py-5">
              ...
              <p className="mt-3 text-sm text-gray-800 dark:text-neutral-200">
                <span className="font-bold">4.8</span> /5 - de 12 mil avaliações
              </p>
              <div className="mt-5">
                {/* Star */}
                <svg
